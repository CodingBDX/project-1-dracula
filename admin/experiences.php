...
<input type="name-of-experience" placeholder="name of experience">
<input type="text" name="date" placeholder="date">
<input type="text" name="address-experience" placeholder="address of experience">
<input type="text" name="about-experience" placeholder="about of experience">
<input type="button" value="envoi-experience">
</form>
</div>
</div>