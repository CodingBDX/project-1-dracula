...
<circle style="fill:#3F0A59;" cx="256" cy="256" r="256"/>
        <path style="fill:#1C0C24;" d="M506.782,307.671L312.889,113.778l-70.675,271.557l-43.103,41.332l83.915,83.915
	...
	341.333,199.111 "/>
        <polygon style="fill:#FEE187;"
                 points="341.333,199.111 312.889,113.778 256.288,113.778 256.288,426.667 312.889,426.667 "/>
	...
	245.124,192.417 223.373,192.417 223.373,214.169 245.124,214.169 245.124,279.424 266.876,279.424 266.876,214.169 "/>
        <polygon style="fill:#1C0C24;" points="288.627,192.417 266.876,192.417 266.876,170.667 256.288,170.667 256.288,279.424
    ...
    <p>
        Wild Code School <?php echo date('Y');
        ?>
    </p>
    <p>
        Naomie - Alexis - Antony - Julien
    </p>
</footer>